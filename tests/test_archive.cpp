...
TEST_F(VectorArchive_test, correct_save) {
    ...
    std::string filepath{"/home/rohitfeb641/vector-db/db/archive/correct_save.bin"};
...
TEST_F(VectorArchive_test, empty_data) {
    test_vector = {{}};
    std::string filepath{"/home/rohitfeb641/vector-db/db/archive/empty_data.bin"};
...
TEST_F(VectorArchive_test, dimension_mismatch) {
    ...
    std::string filepath{"/home/rohitfeb641/vector-db/db/archive/dimension_mismatch.bin"};
    EXPECT_THROW(vecd.save(filepath, test_vector), InvalidOperationError);
}

TEST_F(VectorArchive_test, overwrite_with_shrink) {
    std::string filepath = "/home/rohitfeb641/vector-db/db/archive/overwrite_with_shrink.bin";
    test_vector = generateData(128, 10, 0);
...
TEST_F(VectorArchive_test, test_corruption) {
    std::string filepath = "/home/rohitfeb641/vector-db/db/archive/corrupted.bin";
    EXPECT_FALSE(vecd.verify(filepath));
}

TEST_F(VectorArchive_test, buffer_int_1) { //buff_cnt - 1 -> int means intergrtiy check
    std::string filepath = "/home/rohitfeb641/vector-db/db/archive/buffer_int_1.bin";
...
TEST_F(VectorArchive_test, buffer_int_2) { //buff_cnt + 1
    std::string filepath = "/home/rohitfeb641/vector-db/db/archive/buffer_int_2.bin";
...
TEST_F(VectorArchive_test, buffer_int_3) { //count = 1
    std::string filepath = "/home/rohitfeb641/vector-db/db/archive/buffer_int_3.bin";
...
TEST_F(VectorArchive_test, buffer_int_4) { //large prime
    std::string filepath = "/home/rohitfeb641/vector-db/db/archive/buffer_int_4.bin";
...
std::string filepath = "/home/rohitfeb641/vector-db/db/archive/dim_int_1.bin";
...
std::string filepath = "/home/rohitfeb641/vector-db/db/archive/dim_int_2.bin";
...
std::string filepath = "/home/rohitfeb641/vector-db/db/archive/dim_int_3.bin";
...
//     std::string filepath = "/home/rohitfeb641/vector-db/db/archive/large_data.bin";
//     EXPECT_NO_THROW(vecd.save(filepath, test_vector));
//     EXPECT_NO_THROW(loaded_vector = vecd.load(filepath, false));
//     ASSERT_EQ(loaded_vector, test_vector);
//     EXPECT_TRUE(vecd.verify(filepath));
...
//     EXPECT_FALSE(vecd.verify("/home/rohitfeb641/vector-db/db/archive/dest_int_1.bin"));
// }

// TEST_F(VectorArchive_test, destructive_int_2) {//dataf flip
//     EXPECT_FALSE(vecd.verify("/home/rohitfeb641/vector-db/db/archive/dest_int_2.bin"));
// }

// TEST_F(VectorArchive_test, destructive_int_3) {//crc flip
//     EXPECT_FALSE(vecd.verify("/home/rohitfeb641/vector-db/db/archive/dest_int_3.bin"));
// }

// TEST_F(VectorArchive_test, destructive_int_4) {//header flip
//     EXPECT_FALSE(vecd.verify("/home/rohitfeb641/vector-db/db/archive/dest_int_4.bin"));
// }


// TEST_F(VectorArchive_test, similar_data_int) {//if same data in diff files
//     std::string fpath1{"/home/rohitfeb641/vector-db/db/archive/same_data_int.bin"};
//     std::string fpath2{"/home/rohitfeb641/vector-db/db/archive/same_data_int_copy.bin"};
...
TEST_F(VectorArchive_test, correct_append) {//checks correct append
    test_vector = generateData(128, 10, 0);
    std::string filepath{"/home/rohitfeb641/vector-db/db/archive/correct_append.bin"};
    EXPECT_NO_THROW(vecd.save(filepath, test_vector));
